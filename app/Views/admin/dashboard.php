                ...
                <div class="card">
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="detail">
                                    <p class="detail-subtitle">SISWA</p>
                                    <span class="number"><?= count($siswa); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
                ...
                <div class="card">
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="detail">
                                    <p class="detail-subtitle">KELAS</p>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="content">
                        <div class="head">
                            <h5 class="mb-0">Point Tertinggi</h5>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="content">
                        <div class="head">
                            <h5 class="mb-0">Pelanggaran Palig Sering</h5>
                            <p class="text-muted">Current year website visitor data</p>
                        </div>
                        <div class="canvas-wrapper">
                            <table class="table table-striped">
